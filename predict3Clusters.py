...
inputFile = 'fws04' #change this variable for other transien testing
...
for z in range(X_train.shape[2]):
    ...
    ax[z, pred[0]].plot(T[i,:], X_test[0, :, z], color='b', linewidth=.9)
    ...
    for j in range(C):
        ...
        ax[0, j].set_title(f"Cluster {j+1}", fontsize=15)
